<nav class="navbar navbar-expand-lg fixed-top shadow-sm" style="background-color: #FFFFFF; border: 3px solid #88304E;">
    <div class="container-fluid">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title fw-bold" id="offcanvasNavbarLabel" style="color: #DC3545;">Menu INGAT.IN!
                </h5>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 {{ request()->routeIs('warga.calendar') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2 {{ request()->routeIs('daftar') ? 'active' : '' }}"
                            href="{{ route('daftar') }}">
                            Daftar Kegiatan
                            <span
            ...
            @if (!Auth::user()->isPengurus())
                ...
                <div class="dropdown">
                    <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle p-0"
                        ...
                        <img src="{{ Auth::user()->profile_photo_url }}" alt="Photo Profile" width="30" height="30"
                            class="rounded-circle border border-2 border-primary">
                    </a>

                    <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="min-width: 200px;">
                        <li class="px-3 py-2">
                            <p class="small fw-bold mb-0">{{ Auth::user()->nama_lengkap }}</p>
                        ...
                        <li><a class="dropdown-item" href="{{ route('profile') }}"><i class="bi bi-person-circle me-2"></i>
                                Lihat Profil</a></li>
                        <li><a class="dropdown-item" href="{{ route('settings') }}"><i class="bi bi-gear-fill me-2"></i>
                                Pengaturan</a></li>
