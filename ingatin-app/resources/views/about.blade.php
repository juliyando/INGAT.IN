        ...
        <div class="dev-container">
            <div class="dev-card">
                <div class="dev-photo-wrapper">
                    <div class="blob-bg"></div> <img src="{{asset('images/qonita.png')}}" class="dev-photo" alt="Dev 1">
                </div>
                <div class="dev-info">
            ...
            <div class="dev-card">
                <div class="dev-photo-wrapper">
                    ...
                    <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=crop&q=80&w=800" class="dev-photo" alt="Dev 2">
                </div>
                <div class="dev-info">
    ...
    <script>
        ...
        gsap.utils.toArray(".dev-card").forEach((card, i) => {
            gsap.to(card, {
                ...
                duration: 1,
                ease: "elastic.out(1, 0.5)", /* Efek membal (pop up) */
                scrollTrigger: {
                    trigger: "#developers",
                    start: "top 75%", /* Mulai saat area dev masuk layar */
