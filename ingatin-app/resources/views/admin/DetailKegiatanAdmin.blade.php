     ...
     @section('content')
         <div class="detail-wrapper">
            <div class="detail-card">
                ...
                <hr>
                <p>Ini adalah contoh deskripsi kegiatan. Anda dapat menuliskan penjelasan lengkap mengenai acara, keperluan, peserta, dan detail lainnya yang perlu diketahui warga. Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi pariatur dolores enim vitae illo nesciunt eaque, dignissimos saepe quos magni minus, facilis error corporis doloribus, cum adipisci autem perferendis perspiciatis!
                ...
                <div class="mt-4 d-flex gap-2">
                    <a href="#" class="btn btn-ToArsip"><i class="bi bi-save"></i> Pindah ke arsip?</a>
                </div>
            </div>
        </div>
     @endsection
